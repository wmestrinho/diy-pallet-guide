---
title: The Process — 9 Steps for Any Pallet Project
description: The repeatable 9-step process for building anything from reclaimed pallets, from sourcing to final install.
---
...
```mermaid
flowchart LR
    S["1<br/>Source"] --> I["2<br/>Inspect"]
    I --> D["3<br/>Deconstruct"]
    D --> P["4<br/>Prep"]
    P --> DE["5<br/>Design"]
    DE --> C["6<br/>Cut"]
    C --> A["7<br/>Assemble"]
...
Find and collect your pallets. Ask businesses, check free listings, take only the good ones.
→ Full detail in **[The Basics → Sourcing](basics.md#sourcing-where-to-get-pallets)**.
...
Check every pallet for safety **before** it comes home: IPPC stamp (`HT` good, `MB` never), no rental colors, no contamination.
→ Full detail in **[The Basics → Safety](basics.md#safety-which-pallets-are-safe)**.
...
!!! tip "Cut the nails, don't fight them"
    Trying to lever nailed boards apart splits them. Cutting the nails with a recip saw saves the wood — and your patience.

## 4 — Prep Wood

Remove every nail and staple. Sort boards by thickness, width, and quality. Clean off dirt. Sand in stages (60 → 120 → 220 grit). Set damaged boards aside.
→ Full detail in **[The Basics → Wood Prep](basics.md#wood-prep)**.
